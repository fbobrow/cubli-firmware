...
void AttitudeTrajectory::generate()
{
    ...
    float alpha_x = cos_phi*phi_dot*theta_dot+sin_phi*theta_ddot-sin_phi*phi_dot*sin_theta*psi_dot-cos_phi*cos_theta*theta_dot*psi_dot-cos_phi*sin_theta*psi_ddot;
    float alpha_y = -sin_phi*phi_dot*theta_dot+cos_phi*theta_ddot+cos_phi*phi_dot*sin_theta*psi_dot+sin_phi*cos_theta*theta_dot*psi_dot+sin_phi*sin_theta*psi_ddot;
    ...
    omega_r_x = omega_x + 2.0*(omega_x*(-qu2_qu2 - qu3_qu3) + omega_y*( qu0_qu3 + qu1_qu2) + omega_z*(-qu0_qu2 + qu1_qu3));
    omega_r_y = omega_y + 2.0*(omega_x*(-qu0_qu3 + qu1_qu2) + omega_y*(-qu1_qu1 - qu3_qu3) + omega_z*( qu0_qu1 + qu2_qu3));
    omega_r_z = omega_z + 2.0*(omega_x*( qu0_qu2 + qu1_qu3) + omega_y*(-qu0_qu1 + qu2_qu3) + omega_z*(-qu1_qu1 - qu2_qu2));
    // Calculate angular acceleration reference with Cubli in vertex
    alpha_r_x = alpha_x + 2.0*(alpha_x*(-qu2_qu2 - qu3_qu3) + alpha_y*( qu0_qu3 + qu1_qu2) + alpha_z*(-qu0_qu2 + qu1_qu3));
    alpha_r_y = alpha_y + 2.0*(alpha_x*(-qu0_qu3 + qu1_qu2) + alpha_y*(-qu1_qu1 - qu3_qu3) + alpha_z*( qu0_qu1 + qu2_qu3));
    alpha_r_z = alpha_z + 2.0*(alpha_x*( qu0_qu2 + qu1_qu3) + alpha_y*(-qu0_qu1 + qu2_qu3) + alpha_z*(-qu1_qu1 - qu2_qu2));
}
