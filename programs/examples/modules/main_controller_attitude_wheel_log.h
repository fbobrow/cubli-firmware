        ...
        if (flag) 
        {
            ...
            if ((abs(phi) <= phi_lim) && (!end_log))
            {
                ...
                if (flag_log)
                {
                    ...
                    x[2][j] = att_est.q2;
                    x[3][j] = att_est.q3;
                    x[4][j] = att_est.omega_x;
                    x[5][j] = att_est.omega_y;
                    x[6][j] = att_est.omega_z;
                    x[7][j] = whe_est_1.theta_w;
                    x[8][j] = whe_est_2.theta_w;
                    x[9][j] = whe_est_3.theta_w;
                    x[10][j] = whe_est_1.omega_w;
                    x[11][j] = whe_est_2.omega_w;
                    x[12][j] = whe_est_3.omega_w;
                    u[0][j] = tau_1;
                    u[1][j] = tau_2;
                    u[2][j] = tau_3;
                    j++;
